...
public class AgitatorBackward extends Command {
    public final Agitator agitatorGoBackward;

    // This defines what subsystem is being changed or moved.
    public AgitatorBackward(Agitator agitatorCommand) {
        
        agitatorGoBackward = agitatorCommand;
        addRequirements(agitatorCommand);
    ...
    public void initialize() {
        ...
        agitatorGoBackward.agitatorBackward();
    ...
    public void execute() {
        ...
        System.out.println("AgitatorBackward activated");
    ...
    public void end(boolean interrupted) {
       agitatorGoBackward.agitatorStop();
    }
}
...
public class AgitatorForward extends Command {
    public final Agitator agitatorGoForward;

    // This defines what subsystem is being changed or moved.
    public AgitatorForward(Agitator agitatorCommand) {
        
        agitatorGoForward = agitatorCommand;
    ...
    public void initialize() {
        ...
        agitatorGoForward.agitatorForward();
    ...
    public void execute() {
        ...
        System.out.println("AgitatorForward activated");
    ...
    public void end(boolean interrupted) {
       agitatorGoForward.agitatorStop();
    }
}